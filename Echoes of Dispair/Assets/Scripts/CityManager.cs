    ...
    public void ResolveNatureCard(CardData card, int cityIndex, GameObject sourceCard)
    {
        switch (card.natureCardType)
        {
            case NatureCardType.BreathOfBoreas:
                ScheduleDisaster(cityIndex, DisasterType.StrongWind, 0, 2, 8, sourceCard);
                break;
            ...
            case NatureCardType.TorrentOfTheNaiads:
                ScheduleDisaster(cityIndex, DisasterType.Rain, 0, 2, 6, sourceCard);
                break;
            ...
            case NatureCardType.AwakeningOfNamazu:
                ScheduleDisaster(cityIndex, DisasterType.Tsunami, 12, 2, 2, sourceCard);
                break;
            ...
            case NatureCardType.EyeOfHuracan:
                ScheduleDisaster(cityIndex, DisasterType.Depression, 4, 2, 4, sourceCard);
                break;
        }
    }
    ...
    int ModifyDamageForCity(CityState city, DisasterType disasterType, int baseDamage)
    {
        ...
        switch (disasterType)
        {
            ...
            case DisasterType.Tsunami:
                ...
                if (city.powerCutOffTurns > 0 && disasterType == DisasterType.Earthquake)
                    damage *= 0.5f;
                break;
